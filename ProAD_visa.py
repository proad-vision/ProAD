    ...
    for epoch in range(int(math.ceil(total_iters / len(train_dataloader)))):
        ...
        for data_batch in train_dataloader:
            ...
            if (it + 1) == total_iters:
                ...
                model_save_path = os.path.join(model_params_save_dir, "visa_student.pth")
...
def train_segmentation_model(args, item_list_selected, device, print_fn, mvtec_item_list_all_for_train):
    ...
    params_path = os.path.join("checkpoints", "visa_student.pth")
    ...
    for epoch in range(num_epochs_to_train):
        ...
        if (epoch + 1) % 10 == 0:
            ...
            model_save_path = os.path.join("checkpoints", "visa_afm_upsampler.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./VisA/1cls')
    parser.add_argument('--save_dir', type=str, default='./saved_results')
    parser.add_argument('--save_name', type=str, default='visa_anomaly_detection')
    args = parser.parse_args()

    item_list_all = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2',
    ...
    student_model_path = os.path.join("checkpoints", "visa_student.pth")
