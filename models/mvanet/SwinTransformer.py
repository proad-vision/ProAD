...
# Modification for ProAD: the mmdet logger import is replaced with Python's
# standard logging module, so that mmdet/mmcv are not required at inference.
...
import numpy as np
import logging  # ProAD: replaces mmdet's get_root_logger (mmdet/mmcv not required)
from timm.models import load_checkpoint
from timm.models.layers import DropPath, to_2tuple, trunc_normal_


def get_root_logger():
    """Drop-in replacement for mmdet.utils.get_root_logger (ProAD modification)."""
    return logging.getLogger('mvanet.swin')
