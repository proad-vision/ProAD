...
def main():
    parser = argparse.ArgumentParser(description='VisA Testing Script')
    ...
    student_ckpt_path = os.path.join(args.checkpoint_dir, "visa_student.pth")
    ...
    afm_ckpt_path = os.path.join(args.checkpoint_dir, "visa_afm_upsampler.pth")
